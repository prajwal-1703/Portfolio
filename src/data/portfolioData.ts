...
export const projects: Project[] = [
  ...
  },
  {
    ...
    githubUrl: "https://github.com/Prajwal-1703/Uptimely",
    featured: true,
    date: "Jan 2026",
  },
  {
    ...
    githubUrl: "https://github.com/Prajwal-1703/Private-Cloud-Backup",
    featured: false,
    date: "May 2025",
  },
];
...
export const achievements: Achievement[] = [
  {
    title: "AWS Certification: Technical Professional",
    description: "Accreditation for AWS technical sales and professional services.",
    date: "2026",
    icon: "award",
  },
  {
    title: "AWS Certification: Cloud Economics",
    description: "Accreditation for AWS cloud financial management and value proposition.",
    date: "2026",
    icon: "award",
  },
  {
    title: "AWS Certification: Containers on AWS",
    description: "Specialized accreditation for containerized workloads on AWS infrastructure.",
    date: "2026",
    icon: "award",
  },
  {
    title: "AWS Certification: Migrating Workloads",
    description: "Accreditation for migrating on-premises applications to AWS Cloud.",
    date: "2026",
    icon: "award",
  },
  {
    title: "AWS Certification: Digital Sovereignty",
    description: "Accreditation for AWS data protection and residency compliance.",
    date: "2026",
    icon: "award",
  },
  {
    title: "AWS Certification: ML & Generative AI",
    description: "Accreditation for machine learning and generative AI solutions on AWS.",
    date: "2026",
    icon: "award",
  },
  {
